    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[var(--bg-primary)] p-4">
      <div className="max-w-md w-full text-center fade-in">
        ...
        <p className="text-[var(--text-secondary)] text-base mb-10">
          Turn client promises into verified engineering execution.
        </p>

        <div className="glass-card p-6 flex flex-col gap-3">
          <button
            onClick={() => signIn("github", { callbackUrl: "/dashboard/pulse" })}
          ...
          <button
            onClick={() => signIn("google", { callbackUrl: "/dashboard/pulse" })}
            className="btn-secondary w-full py-3 flex items-center justify-center gap-3"
          >
            <GoogleIcon />
